...
\begin{minipage}[t]{0.5\textwidth} % Minipage for left logo
    ...
    \includegraphics[width=0.2\textwidth]{./ofppt-logo.png}
\end{minipage}
...
\vspace{0.3cm}
First and last name : MALLOULI ABDELHAY\\
Level: Qualifying training\\
Course: Web Developer – Bootcamp mode\\
Group: DWB101\\
...
\bigskip
\textbf{Acknowledgment:} I would like to express my sincere gratitude to my teacher, Fatine Chebab, for her guidance and support throughout this project. I also extend heartfelt thanks to my teammate, my classmates for the collaborative environment, and my family for their continuous encouragement and support.
...
\begin{itemize}
    ...
    \item \textbf{Vendor Listing:} Vendors can list their offerings for event organizers to browse by contacting the admin of website.
    \item \textbf{Admin Dashboard for Oversight:} Administrators will have a dedicated interface to manage users, events, and create and manage vendors, ensuring system integrity and compliance.
...
\begin{itemize}
    ...
    \item \textbf{Vendor Login and Creating:} let the vendor Create 
